...
- (void)viewWillAppear:(BOOL)animated {
	...
	self.tabBarController.navigationItem.title = @"Global Chat";
	...
	[MGWU getGlobalMessagesWithCallback:@selector(reload:) onTarget:self];
...
- (void)send
{
	...
	{
		[MGWU sendGlobalMessage:message.text withCallback:@selector(reload:) onTarget:self];
		[message setText:@""];
	}
}
...
- (void)keyboardWillShow:(NSNotification *)notif {
	...
	int delta = 216-44; //Height of keyboard - height of tab bar
